...
\entry{Entrepreneur}{
  ...
  \begin{itemize}
    \item Sole proprietor of business with client base of 180 customers, logging over 1500 job hours
    \item Performed services such as computer/server setup and maintenance, network installation
  \end{itemize}
}
...
\entry{Prof. Rakesh Kumar}{
  ...
  Fall 2015
    ...
    \textbf{M. Vilim}, H. Duwe, R. Kumar, ``Approximate Bitcoin Mining.'' \emph{DAC, 2016.}
}
\entry{Prof. Kunle Olukotun}{
  ...
  \begin{itemize}
    \item Y. Zhang, A. Rucker, M. Vilim, \emph{et al.} ``Compiler-Directed Hybrid Networks for Spatial Architectures.'' \emph{ASPLOS, 2019.} (Submitted)
  \end{itemize}
}
