...
\newcommand{\entry}[3]{%
  \hfill%
  \parbox[t]{1.6in}{\raggedleft\vfill{\large \texthalfbf{#1}}\\#2\vfill}%
  \hskip 0.25in%
...
\entry{Prof. Kunle Olukotun}{
  ...
  \begin{itemize}
    \item Y. Zhang, A. Rucker, \texthalfbf{M. Vilim}, \emph{et al.} ``Compiler-Directed Hybrid Networks for Spatial Architectures.'' \emph{ASPLOS, 2019.} (Submitted)
  \end{itemize}
}
\entry{Prof. Rakesh Kumar}{
  ...
  \begin{itemize}
    ...
    \item \texthalfbf{M. Vilim}, H. Duwe, R. Kumar, ``Approximate Bitcoin Mining.'' \emph{DAC, 2016.}
  \end{itemize}
}
